                    ...
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) => setBaseHomePrice(parseFloat(e.target.value.replace(/,/g, '')) || 0)}
                                className="mt-1"
                                onKeyPress={(e) => {
                                    if (!/[\d.]/.test(e.key) && e.key !== 'Backspace' && e.key !== 'Delete') {
                                        e.preventDefault();
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) => setPercentAnnualHomeAppreciation(parseFloat(e.target.value) || 0)}
                                className="mt-1"
                                step="0.1"
                            />
                        </div>
                        ...
                        <div className="mt-1 flex h-10 w-full rounded-md border border-input bg-gray-100 px-3 py-2 text-sm ring-offset-background">
                            <div className="font-medium text-s">
                                ${Math.round(currentAppreciatedPrice).toLocaleString()}{"   "}{currentForm.monthOfPurchase > 0 
                                    ? ` After   ${currentForm.monthOfPurchase} months appreciation` 
                                    : 'Base price'}
                            </div>
                        </div>
                    </div>
